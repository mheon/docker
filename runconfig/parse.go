...
func Parse(cmd *flag.FlagSet, args []string) (*Config, *HostConfig, *flag.FlagSet, error) {
	var (
		...
		flUserNamespace   = cmd.Bool([]string{"-userns"}, false, "Enable user namespaces, making container root a nonprivileged user on the host")
	)
